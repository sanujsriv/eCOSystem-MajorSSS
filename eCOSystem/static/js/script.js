...
$(window).on("load", function() {
    ...
    $(".exp-bx-open-custom").on("click", function(){
        $("#set-exp-company").val($("#get-exp-company1").attr("value"));
        $("#set-exp-title").val($("#get-exp-title1").attr("value"));
        $("#set-exp-location").val($("#get-exp-location1").attr("value"));
        $("#set-exp-work_field").val($("#get-exp-work_field1").attr("value"));
        $("#set-exp-from_date").val($("#get-exp-from_date1").attr("value"));
        $("#set-exp-to_date").val($("#get-exp-to_date1").attr("value"));
        $("#set-exp-descriptionExp").val($("#get-exp-descriptionExp1").attr("value"));
        $("#experience-box-custom").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#experience-box-custom").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
...
//  ============= INTEREST EDIT FUNCTION =========

    $(".int-box-open").on("click", function(){
        $("#interest-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#interest-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });

    //  ============= CERTIFICATIONS EDIT FUNCTION =========

    $(".cert-bx-open").on("click", function(){
        $("#certification-box").addClass("open");
        $(".wrapper").addClass("overlay");
        return false;
    });
    $(".close-box").on("click", function(){
        $("#certification-box").removeClass("open");
        $(".wrapper").removeClass("overlay");
        return false;
    });
